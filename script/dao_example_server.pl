...
my $help              = 0;
my $host              = undef;
my $port              = $ENV{DAO_EXAMPLE_PORT} || $ENV{CATALYST_PORT} || 3000;
my $keepalive         = 0;
my $restart           = $ENV{DAO_EXAMPLE_RELOAD} || $ENV{CATALYST_RELOAD} || 0;
my $background        = 0;
my $pidfile           = undef;
...
dao_example_server.pl - Catalyst Testserver

=head1 SYNOPSIS

dao_example_server.pl [options]
